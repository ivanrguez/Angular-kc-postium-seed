...
export class PostService {
  ...
  getPosts(): Observable<Post[]> {
    ...
    let ordenFiltro = new URLSearchParams();
    ordenFiltro.set('_sort', 'publicationDate');
    ordenFiltro.set('_order', 'DESC');
    ordenFiltro.set('publicationDate_lte', new Date().getTime().toString());
    let options = new RequestOptions();
    options.search = ordenFiltro;
